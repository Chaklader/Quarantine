...
import com.edgelab.hospital.v1.QuarantineOne;
import org.junit.Before;
import org.junit.Test;


public class QuarantineOneTest {

    private QuarantineOne quarantine;

    @Before
    public void setUp() {
        // The responsibility of the QuarantineOne object is to simulate diseases on a group of patients.
        ...
        // D : Diabetes
        // T : Tuberculosis
        quarantine = new QuarantineOne("F,H,D,D,D,H,T");

        // QuarantineOne provides medicines to the patients, but can not target a specific group of patient.
        // The same medicines are always given to all the patients.

        // Then QuarantineOne can provide a report with this format:
        // "F:1 H:2 D:0 T:1 X:3"
